...
export function initRegistration(noa) {
  ...
  var blockIDs: { [key: string]: any } = {};
  var _id = 1;

  blockIDs.dirtID = noa.registry.registerBlock(_id++, { material: "dirt" });
  blockIDs.shinyDirtID = noa.registry.registerBlock(_id++, {
    material: "shinyDirt",
  });
  ...
  blockIDs.testID1 = noa.registry.registerBlock(_id++, {
  ...
  blockIDs.testID3 = noa.registry.registerBlock(_id++, {
    material: ["1", "2", "a"],
  });
